...
const ResultPage = () => {
  ...
  return (
    <div className="h-screen bg-slate-950 bg-[radial-gradient(circle_400px_at_50%_300px,#3e3e3e,transparent)] text-white flex flex-col">
      ...
      {/* Main Content */}
      <div className="flex flex-1 p-6 gap-6 overflow-hidden flex-col lg:flex-row">
        {/* Left Panel */}
        <div className="lg:w-1/3 w-full bg-slate-900/70 rounded-xl p-6 shadow-lg border border-slate-700 flex flex-col">
          <h2 className="text-xl font-semibold text-blue-300 text-center mb-6">
            Score Board
          </h2>
          <h2 className="text-xl font-semibold text-blue-300 text-center mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="bg-slate-800/70 p-3 rounded-lg text-center hover:scale-105 transition">
              <p className="text-purple-300 font-bold">100%</p>
              <p className="text-sm">Completions</p>
            </div>
            <div className="bg-slate-800/70 p-3 rounded-lg text-center hover:scale-105 transition">
              <p className="text-blue-300 font-bold">{totalQuestions}</p>
              <p className="text-sm">Questions</p>
            </div>
            <div
              className="bg-slate-800/70 p-3 rounded-lg text-center hover:scale-105 transition cursor-pointer"
              onClick={() => setDisplayCorrectAnswers(true)}
            >
              <p className="text-green-400 font-bold">{noOfCorrectAnswers}</p>
            ...
            >
              <p className="text-red-400 font-bold">{noOfInCorrectAnswers}</p>
        ...
        {/* Right Panel */}
        <div className="lg:w-2/3 w-full bg-slate-900/70 rounded-xl p-6 shadow-lg border border-slate-700 h-full overflow-y-auto scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-slate-800">
